    ...
    return (
        <div className="flex flex-col w-full">
            ...
            <div className="ml-8 w-1/2 justify-between leading-normal mt-7">
              <h1 className="text-4xl font-[400]">Sign in faster</h1>
            </div>
            <div className="ml-8 w-1/2 justify-between leading-normal mt-5">
                <Link href="/">
                <div className="flex flex-row text-gray-800 h-7.5 cursor-pointer justify-start items-start hover:bg-gray-100">
